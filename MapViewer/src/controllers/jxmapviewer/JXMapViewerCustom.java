package controllers.jxmapviewer;
...
public class JXMapViewerCustom extends JXMapViewer {
    ...
    public void setRoutingData(List<RoutingData> routingData) {
       ...
       // System.out.println( ));
        routingData.forEach(a ->  datosDelRoutingData(a));
       repaint();
    }
    public static void datosDelRoutingData(RoutingData dato)
    {
        System.out.println("Distancia " + dato.getDistance());
        System.out.println("Lista de puntos " + dato.getPointList());
        System.out.println("Descripcion " + dato.getTurnDescription());
        System.out.println("-------------------------------------------------");
    }
